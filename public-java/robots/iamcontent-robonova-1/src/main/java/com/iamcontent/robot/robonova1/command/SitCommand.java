 ...
 */
public class SitCommand extends CompoundServoCommand<ServoId> {
	...
	public SitCommand() {
		super(
			...
			immutableCommand(LEFT_HIP_FLEXOR, 1.0, 1.0, 0.05),
			immutableCommand(RIGHT_HIP_FLEXOR, 1.0, 1.0, 0.05),
			immutableCommand(LEFT_KNEE_FLEXOR, 1.0, 1.0, 0.05),
			immutableCommand(RIGHT_KNEE_FLEXOR, 1.0, 1.0, 0.05),
			immutableCommand(LEFT_ANKLE_PLANTARFLEXOR, 0.07, 1.0, 0.02),
			immutableCommand(RIGHT_ANKLE_PLANTARFLEXOR, 0.07, 1.0, 0.02),
