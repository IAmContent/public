...
/**
 * Describes the bidirectional conversion of a double value.
 * @author Greg Elderfield
 */
public interface DoubleConverter {
	double applyForward(double v);
	double applyBackward(double v);
	
    static DoubleConverter IDENTITY = new DoubleConverter() {
		@Override
