...
public class ResourceUtils {
	...
	public static void appendResource(String fileName, Appendable onto) throws IOException {
		try(final InputStream in = getStreamOrThrow(fileName)) {
			copyInputStream(in, onto);
		};
	}

	public static InputStream getStreamOrThrow(String fileName) throws FileNotFoundException {
