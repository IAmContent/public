...
/**
 * Defines an immutable {@link AnalogIOCalibration}.
 * @author Greg Elderfield
 */
public class ImmutableAnalogIOCalibration implements AnalogIOCalibration {

	private final DoubleConverter value;
	
	public ImmutableAnalogIOCalibration(DoubleConverter value) {
		this.value = value;
	}
