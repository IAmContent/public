...
Note that the _PololuCommandLineDriver_ uses a [ServoSourceCalibrator](../../../../../io/iamcontent-servos/src/site/md/com.iamcontent.device.servo.calibrate.md) so that the input position, speed and acceleration values are all in the range 0.0..1.0. The configuration file for this is at [src/main/resources/servo/pololu-maestro-calibration.json](../../main/resources/servo/pololu-maestro-calibration.json).
